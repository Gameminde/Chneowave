...
class TestLaunchGUI:
    ...
    def test_gui_startup_simulation(self, qapp):
        ...
        try:
            ...
            pytest.fail(f"Erreur lors du test de lancement GUI: {e}")
    ...
    def test_gui_components_loaded(self, qapp):
        ...
        try:
            ...
            assert hasattr(main_window, 'welcome_view'), "WelcomeView manquante"
            ...
            expected_views = ['welcome', 'acquisition', 'analysis']
            ...
            pytest.fail(f"Erreur lors du test des composants GUI: {str(e)}")
    ...
    def test_simulation_backend_loaded(self, qapp):
        ...
        try:
            ...
            assert hasattr(main_window, 'controller'), "Contrôleur principal manquant"
            ...
            pytest.fail(f"Erreur lors du test du backend de simulation: {str(e)}")
