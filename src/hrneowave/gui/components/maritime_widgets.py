...
class MaritimeCard(QFrame):
    """
    Card maritime standardisée avec élévation et animations fluides.
    Respecte le Golden Ratio et les normes d'accessibilité.
    """
    ...
    def __init__(self, 
        ...
        # Correction du problème d'initialisation - passage du parent à QFrame sans argument nommé
    ...
    def _setup_ui(self):
        ...
        self.setFixedSize(323, 200)  # Golden Ratio: 323/200 ≈ 1.618
        
        # Layout principal
        layout = QVBoxLayout(self)
        layout.setContentsMargins(21, 21, 21, 21)  # space-md
        ...
        if self.content:
            ...
            self.content_label.setFont(self._get_content_font())
    ...
    def _setup_animations(self):
        ...
        self.elevation_animation.setDuration(150)  # transition-fast
        self.elevation_animation.setEasingCurve(QEasingCurve.Type.OutCubic)
        
    def _apply_maritime_style(self):
        """Application du style maritime avec élévation."""
        # Utilisation des classes CSS du design system maritime
        self.setProperty("class", "MaritimeCard")
        
        # Effet d'ombre pour l'élévation
        self._apply_elevation(self.elevation)
        
    def _apply_elevation(self, level: int):
        """Application de l'effet d'élévation."""
        shadow = QGraphicsDropShadowEffect()
        shadow.setBlurRadius(level * 4)
        shadow.setXOffset(0)
        shadow.setYOffset(level)
    ...
    def _get_content_font(self) -> QFont:
    ...
    def enterEvent(self, event):
        ...
        if not self._is_hovered:
            ...
            self._apply_elevation(3)  # Élévation augmentée
            ...
            self.elevation_animation.setEndValue(new_rect)
    ...
    def leaveEvent(self, event):
        ...
        if self._is_hovered:
            self._is_hovered = False
            self._apply_elevation(self.elevation)  # Retour à l'élévation normale
